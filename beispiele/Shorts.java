...
public class Shorts {
  private static short numberOfVars = 202;
  private static ArrayList<VarName> vars = new ArrayList<>();

  private static List<List<Short>> initialClauses;
  private static List<List<Short>> safetyClauses;
  private static List<List<Short>> transitionClauses;
  ...
  public static void main(String[] args) throws TimeoutException, IOException{
    ...
    initialClauses = readCNF("D:\\University\\Project\\CNFs\\javaCNF\\beispiele\\Files\\Phil\\initial.cnf");
    safetyClauses = readCNF("D:\\University\\Project\\CNFs\\javaCNF\\beispiele\\Files\\Phil\\safety1.cnf");
    transitionClauses = readCNF("D:\\University\\Project\\CNFs\\javaCNF\\beispiele\\Files\\Phil\\dimacs_transitions.cnf");
...
//    System.out.println("Formula in CNF, with more variables: " + cnf(f));
  ...
  private static List<List<Short>> readCNF(String filename) throws IOException{
    final List<List<Short>> clauses = Files.lines(Paths.get(filename))
            // Trim the lines:
  ...
  private static Formula listToFormula(List<List<Short>> clauses, boolean negateFormula, boolean isPrimed) {
   ...
   */
  private static Formula createClause(List<List<Short>> clauses, boolean negateFormula, boolean isPrimed, int j) {
